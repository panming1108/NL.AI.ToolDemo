...
{
    public class WaveReviewViewModel : ViewModelBase, IWaveReviewViewModel
    {
        public WaveReviewViewModel(IMessageModule iMessageModule, ICacheManager iCacheManager, ISkyCastleTrailer skyCastleTrailer, IDialogFactory dialogFactory, ICommandFactory commandFactory) : base(iMessageModule, iCacheManager, skyCastleTrailer, dialogFactory, commandFactory)
        {
        }
